...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" action="http://<?php echo APP_HOST; ?>/clienteLicitacao/salvar"
                ...
                <div class="tab-content">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="trocaMarca" id="trocaMarca"
                                            value="<?php echo $Sessao::retornaValorFormulario('trocaMarca'); ?>"
                                            required>
                                            <option value="">Troca de Marca</option>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="tipoCliente" id="tipoCliente"
                                            value="<?php echo $Sessao::retornaValorFormulario('tipoCliente'); ?>"
                                            required>
                    ...
                    <div class="tab-pane" id="kt_builder_endereco">
                        <input type="hidden" id="pessoa" name="pessoa"
                            value="<?php echo $Sessao::retornaValorFormulario('pessoa'); ?>" class="form-control">
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-8">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="kt-input-icon kt-input-icon--right">
                                        <input type="text" name="cidade-autocomplete" id="cidade-autocomplete"
                                            ...
                                            value=<?php echo $viewVar['cliente']->getEndCidade()->getCidNome(); ?>>

                                        <input type="hidden" id="cidade" name="cidade"
                                            value=<?php echo $viewVar['cliente']->getEndCidade()->getCidId(); ?>>
                                        <span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i
                                                    class="la la-bookmark-o"></i></span></span>
                                    </div>
