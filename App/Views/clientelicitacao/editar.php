...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" action="http://<?php echo APP_HOST; ?>/clienteLicitacao/atualizar"
            ...
            <div class="kt-portlet__body">
                ...
                <input type="hidden" class="form-control" name="codCliente" id="codCliente"
                    value="<?php echo $viewVar['clienteLicitacao']->getCodCliente(); ?>" required>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="trocaMarca" id="trocaMarca">
                                            ...
                                            <option value="<?php echo $viewVar['clienteLicitacao']->getTrocaMarca(); ?>"
                                                <?php echo ($viewVar['clienteLicitacao']->getTrocaMarca() == $viewVar['clienteLicitacao']->getTrocaMarca()) ? "selected" : ""; ?>>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="tipoCliente" id="tipoCliente"
                                            value="<?php echo $viewVar['clienteLicitacao']->getTipoCliente(); ?>"
                                            required>
                                            <option
                                                value="<?php echo $viewVar['clienteLicitacao']->getTipoCliente(); ?>">
                                                <?php echo $viewVar['clienteLicitacao']->getTipoCliente(); ?></option>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        ...
                                        <option value="<?php echo $situacoes->getSitId(); ?>"
                                            <?php echo ($viewVar['clienteLicitacao']->getSituacoes()->getSitId() == $situacoes->getSitId()) ? "selected" : ""; ?>>
                                ...
                                <div class="col-lg-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="contato" name="contato" class="form-control" 
                                                value="<?php echo $viewVar['clienteLicitacao']->getCliContato(); ?>"
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">                                    
                                            ...
                                            value="<?php echo $viewVar['clienteLicitacao']->getCliCargo();?>"
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">                                    
                                            ...
                                            <input type="text" id="telefone" name="telefone" class="form-control" 
                                                value="<?php echo $viewVar['clienteLicitacao']->getCliTelefone(); ?>"
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="input-group">                                    
                                            ...
                                            <input type="text" id="celular" name="celular" class="form-control" 
                                                value="<?php echo $viewVar['clienteLicitacao']->getCliCelular(); ?>"
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group">                                    
                                            ...
                                            <input type="text" id="email" name="email" class="form-control" 
                                                value="<?php echo $viewVar['clienteLicitacao']->getCliEmail(); ?>"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="kt-input-icon kt-input-icon--right">
                                        <input type="text" name="cidade-autocomplete" id="cidade-autocomplete"
                                            ...
                                            value="<?php echo $viewVar['clienteLicitacao']->getEndCidade()->getCidNome() ." - UF ".
                                            $viewVar['clienteLicitacao']->getEndCidade()->getEstado()->getEstUf(); ?>">
                ...
                <div class="kt-form__actions">
                    ...
                    <h5 class="text-danger text-center" name="informacao" id="informacao">
                        <p><strong><em>Cadastrado em:
                                    <?php echo $viewVar['clienteLicitacao']->getCliDataCadastro()->format('d/m/Y H:i:s'); ?>
                                    - Ultima Alteracao em:
                                    <?php echo $viewVar['clienteLicitacao']->getCliDataAlteracao()->format('d/m/Y H:i:s')  ?>
                                    Por: <?php echo $viewVar['clienteLicitacao']->getUsuario()->getApelido() ; ?>
                                </em></strong></p>
                    </h5>
                </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="apagarContato" tabindex="-1" role="dialog" aria-labelledby="apagarContato" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body bg-light">
        Deseja realmente excluir o registro selecionado? <span id="nomecontato" class="text-danger" name="nomecontato"></span>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-info btn-elevate btn-pill btn-elevate-air" data-dismiss="modal">Fechar</button>
        <button type="button" class="btn btn-outline-danger btn-elevate btn-pill btn-elevate-air" id="btnExluirContato">Excluir</button>
      </div>
    </div>
  </div>
</div>