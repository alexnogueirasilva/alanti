...
<head>
	...
	<meta name="author" content="Alex Nogueira da Silva" />
	<meta http-equiv="content-language" content="pt-br" />	
	<meta http-equiv="content-type" content="text/html; charset=UTF-8" />		
	<meta name="copyright" content="© ALANTI" />
	<meta name="description" content="Updates and statistics">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<input type="hidden" class="form-control" name="appHosp" id="appHosp" value="http://<?php echo APP_HOST; ?>" required>
	<!-- jQuery CDN -->
    ...
    <!--end::Select2 multo select -->
    <!--end::Layout Skins -->
    <!-- link rel="shortcut icon" href="http://< ?php echo APP_HOST; ?>/public/assets/media/logos/favicon.ico"/ -->

    <!--begin::Page Vendors Styles(used by this page) -->
    <!-- link href="//www.amcharts.com/lib/3/plugins/export/export.css" rel="stylesheet" type="text/css"/-->

    <!--begin::Page Vendors Styles(used by this page) -->
    <link href="http://<?php echo APP_HOST; ?>/public/assets/demo/default/base/style.bundle.css" rel="stylesheet"
          type="text/css"/>
    <link href="http://<?php echo APP_HOST; ?>/public/assets/app/custom/error/error-v2.default.css" rel="stylesheet"
          type="text/css"/>
    <link href="http://<?php echo APP_HOST; ?>/public/assets/vendors/general/select2/dist/css/select2.css"
          rel="stylesheet" type="text/css"/>
    <link href="http://<?php echo APP_HOST; ?>/public/assets/vendors/custom/datatables/datatables.bundle.css"
          rel="stylesheet" type="text/css"/>
    <link href="http://<?php echo APP_HOST; ?>/public/assets/app/custom/login/login-v4.default.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link rel="shortcut icon" href="http://<?php echo APP_HOST; ?>/public/assets/media/logos/favicon-alanti.ico"/>
