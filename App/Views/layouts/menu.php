		        ...
		        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
		            ...
		            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
		                <div class="kt-aside__brand-logo">
		                    <a href="http://<?php echo APP_HOST; ?>">
		                        <img class="rounded-circle" alt="Logo" src="http://<?php echo APP_HOST; ?>/public/assets/media/logos/logo2.jpeg" />
		                    </a>
		                </div>
		            ...
		            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
		                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
		                    ...
		                    <ul class="kt-menu__nav ">
		                        <li <?php if ($viewVar['nameController'] == "HomeController") { ?>
		                            <?php } ?>class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a
		                                href="http://<?php echo APP_HOST; ?>" class="kt-menu__link "><span
                                 ...
                                 <li <?php if ($viewVar['nameController'] == "HomeController") { ?>
		                            <?php } ?>class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
		                                href="http://<?php echo APP_HOST; ?>/home/dashboard" class="kt-menu__link "><span
		                                    class="kt-menu__link-icon fas fa-tachometer-alt"></span><span class="kt-menu__link-text ">Dashboard</span></a>
                                </li>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">LICITACAO</span><i
		                                ...
		                                <ul class="kt-menu__subnav">
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                ...
		                                                class="kt-menu__link-text">EDITAL</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "EditalController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/edital/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "EditalController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/edital/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">GARANTIA</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "GarantiaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/garantia/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "GarantiaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/garantia/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">CONTRATO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "ContratoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/contrato/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "ContratoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/contrato/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">PEDIDO</span><i
		                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                <ul class="kt-menu__subnav">
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">PEDIDO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "PedidoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/pedido/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "PedidoController") { ?><?php } ?>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">FALTA PEDIDO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "PedidoFaltaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/PedidoFalta/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "PedidoFaltaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/PedidoFalta/listar"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">NOTIFICACAO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "NotificacaoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/notificacao/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "NotificacaoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/notificacao/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">LOGISTICA</span><i
		                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                <ul class="kt-menu__subnav">
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">LOGISTICA</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">

		                                                <li <?php if ($viewVar['nameController'] == "LogisticaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/logistica/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "LogisticaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/logistica/rastreio"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Rastreio</span></a></li>
		                                            </ul>
		                                        </div>
		                                    </li>
		                                </ul>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">PRODUTO</span><i
		                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                <ul class="kt-menu__subnav">
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">PRODUTO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "ProdutoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Produto/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "ProdutoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Produto/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">MARCA</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "MarcaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Marca/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "MarcaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Marca/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">SUGESTOES</span><i
		                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                <ul class="kt-menu__subnav">
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">SUGESTOES</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "SugestoesController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/sugestoes/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "SugestoesController") { ?><?php } ?>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">CADASTROS</span><i
		                                    class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                <ul class="kt-menu__subnav">
		                                    <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
		                                            class="kt-menu__link"><span
		                                                class="kt-menu__link-text">Cadastros</span></span></li>
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">CLIENTE</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "ClienteLicitacaoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/clienteLicitacao/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "ClienteLicitacaoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/clienteLicitacao/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">ESTADO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "EstadoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/estado/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "EstadoController") { ?><?php } ?>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">CIDADE</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "CidadeController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/cidade/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "CidadeController") { ?><?php } ?>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">SLA</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "SlaController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/sla/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "SlaController") { ?><?php } ?>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">FORNECEDOR</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "FornecedorController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Fornecedor/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "FornecedorController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Fornecedor/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">USUARIO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "UsuarioController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Usuario/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "UsuarioController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/Usuario/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">DEPARTAMENTO</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "DepartamentoController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/departamento/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "DepartamentoController") { ?><?php } ?>
		                                    ...
		                                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                                        data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
		                                            class="kt-menu__link kt-menu__toggle"><i
		                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                class="kt-menu__link-text">TRANSPORTADORA</span><i
		                                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
		                                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
		                                            <ul class="kt-menu__subnav">
		                                                <li <?php if ($viewVar['nameController'] == "TransportadoraController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/transportadora/cadastro"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Cadastro</span></a></li>
		                                                <li <?php if ($viewVar['nameController'] == "TransportadoraController") { ?><?php } ?>
		                                                    class="kt-menu__item " aria-haspopup="true"><a
		                                                        href="http://<?php echo APP_HOST; ?>/transportadora/"
		                                                        class="kt-menu__link "><i
		                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
		                                                            class="kt-menu__link-text">Lista</span></a></li>
		                                            </ul>
		                        ...
		                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
		                            data-ktmenu-submenu-toggle="hover"><a href="http://<?php echo APP_HOST; ?>/login/logout"
		                                class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
		                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
		                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
		                                        class="kt-svg-icon">
		                                    ...
		                                    </svg></span><span class="kt-menu__link-text">SAIR</span</a>		                            
								</li>	
		                                                ...
		                                                <ul class="kt-menu__inner">
		                                                    ...
		                                                    <li class="kt-menu__item " aria-haspopup="true"><a
		                                                            href="javascript:;" class="kt-menu__link "><span
		                                                                ...
		                                                                class="kt-menu__link-text">Completed Tasks</span></a>
		                                                    </li>
		                                                    <li class="kt-menu__item " aria-haspopup="true"><a
		                                                            href="javascript:;" class="kt-menu__link "><span
		                                                                class="kt-menu__link-icon"><svg
		...
		-->
		                        ...
		                        <div
		                            ...
		                            <form>
		                                ...
		                                <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b"
		                                    style="background-image: url(http://<?php echo APP_HOST; ?>/public/assets/media/misc/bg-1.jpg)">
		                                    ...
		                                    <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245"
		                                        ...
		                                        <div class="kt-mycart__item">
		                                            <div class="kt-mycart__container">
		                                                ...
		                                                <a href="#" class="kt-mycart__pic">
		                                                    <img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product9.jpg"
		                                                        title="">
		                                                </a>
		                                            </div>
		                                        </div>
		                                        <div class="kt-mycart__item">
		                                            <div class="kt-mycart__container">
		                                                ...
		                                                <a href="#" class="kt-mycart__pic">
		                                                    <img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product13.jpg"
		                                                        title="">
		                                                </a>
		                                            </div>
		                                        </div>
		                                        <div class="kt-mycart__item">
		                                            <div class="kt-mycart__container">
		                                                ...
		                                                <a href="#" class="kt-mycart__pic">
		                                                    <img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product16.jpg"
		                                                        title="">
		                                                </a>
		                                            </div>
		                                        </div>
		                                        <div class="kt-mycart__item">
		                                            <div class="kt-mycart__container">
		                                                ...
		                                                <a href="#" class="kt-mycart__pic">
		                                                    <img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product15.jpg"
		                                                        title="" alt="">
		                                                </a>
		                                            </div>
		                                        </div>
		                    ...
		                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
		                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
		                            <span class="kt-header__topbar-icon">
		                                <img class=""
		                                    src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/020-flag.svg"
		                                    alt="" />
		                            </span>
		                        </div>
		                        <div
		                            ...
		                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
		                                ...
		                                <li class="kt-nav__item">
		                                    <a href="#" class="kt-nav__link">
		                                        <span class="kt-nav__link-icon"><img
		                                                src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/016-spain.svg"
		                                                alt="" /></span>
		                                ...
		                                <li class="kt-nav__item">
		                                    <a href="#" class="kt-nav__link">
		                                        <span class="kt-nav__link-icon"><img
		                                                src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/017-germany.svg"
		                                                alt="" /></span>
		                        ...
		                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
		                            <div class="kt-header__topbar-user">
		                                ...
		                                <span class="kt-header__topbar-username kt-hidden-mobile">
		                                    <a><i class="fa fa-user"></i><b class="hidden-xs">
		                                            <?php echo $_SESSION['apelido']; ?> </b> </a>
		                                </span>
		                                <img class="kt-hidden" alt="Pic"
		                                    src="http://<?php echo APP_HOST; ?>/public/assets/media/users/300_25.jpg" />
		                        ...
		                        <div
		                            ...
		                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
		                                ...
		                                <div class="kt-user-card__avatar">
		                                    ...
		                                    <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
		                                    <span
		                                        class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><a><i
		                                                class="fa fa-user"></i><b class="hidden-xs"> </b> </a></span>
		                                </div>
		                                <div class="kt-user-card__name">
		                                    <a><i class="fa fa-user"></i> Você está logado como <b class="hidden-xs">
		                                            <?php echo $_SESSION['apelido']; ?> </b> </a>
		                                </div>
		                            ...
		                            <div class="kt-notification">
		                                ...
		                                <div class="kt-notification__custom">
		                                    <a href="http://<?php echo APP_HOST; ?>/login/logout"
		                                        class="btn btn-label-brand btn-sm btn-bold">sair</a>
		                                </div>
		                            </div>
		                ...
		                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
		                    <div class="kt-subheader__main">
		                        ...
		                        <a><i class="fa fa-user" id="andreteste" name="andreteste"></i>
		                            <b class="hidden-xs"> <?php echo $_SESSION['apelido']; ?> </b>
		                        </a>
		                        ...
		                        <div class="kt-subheader__wrapper">
		                            ...
		                            <a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker"
		                                ...
		                                <span class="kt-subheader__btn-daterange-title"
		                                    id="kt_dashboard_daterangepicker_title">Hoje</span>&nbsp;
		                                <span class="kt-subheader__btn-daterange-date"
		                                    id="kt_dashboard_daterangepicker_date">Julho 01</span>
