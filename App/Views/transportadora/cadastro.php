                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-2">
                                    ...
                                    <input type="text" id="cnpj" name="cnpj" onkeyup="validarCnpj()" class="form-control" 
                                        value="<?php echo $viewVar['transportadora']->getTraCnpj(); ?>"
                                        placeholder="Entre com CNPJ"><div class="input-group-prepend">
                            ...
                            <div class="form-group row">                               
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <option value="">Status da Transportadora</option>
                                    ...
                                    <span class="form-text text-muted">Favor Informar o Status</span>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="cidade-autocomplete" id="cidade-autocomplete"
                                            ...
                                            value=<?php echo $viewVar['transportadora']->getEndCidade()->getCidNome(); ?>>
