...
/*
         // banco maquina local
        define('APP_HOST'       , $_SERVER['HTTP_HOST'] . "/base-teste");
        define('PATH'           , realpath('./'));
        define('TITLE'          , "ALANTI - Aplicação Administrativa ");
       ...
       // banco hospedagem local base teste
        define('APP_HOST'       , $_SERVER['HTTP_HOST'] . "/base-teste" );
        define('PATH'           , realpath('./'));
        define('TITLE'          , "ALANTI - Aplicação Administrativa ");
        define('DB_HOST'        , "mysql873.umbler.com:41890;charset=utf8");
        define('DB_USER'        , "base-teste");
        define('DB_PASSWORD'    , "Bruna2012*");
        define('DB_NAME'        , "base-teste");
        define('DB_DRIVER'      , "mysql");


// banco hospedagem base teste
        define('APP_HOST'       , $_SERVER['HTTP_HOST'] );
        define('PATH'           , realpath('./'));
        define('TITLE'          , "ALANTI - Aplicação Administrativa ");
        define('DB_HOST'        , "mysql873.umbler.com;charset=utf8");
        define('DB_USER'        , "base-teste");
        define('DB_PASSWORD'    , "Bruna2012*");
        define('DB_NAME'        , "base-teste");
        define('DB_DRIVER'      , "mysql");
*/
        ...
        define('TITLE', "ALANTI - Aplicação Administrativa ");
        define('DB_HOST', "mysql873.umbler.com;charset=utf8");
        define('DB_USER', "fabmed_");
        define('DB_PASSWORD', "Bruna2012*");
        define('DB_NAME', "fabmed_");
        define('DB_DRIVER', "mysql");       
